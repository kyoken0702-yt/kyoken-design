...
const products = [
  ...
  ["lightbox-details.html", "バックライトフィルム", "Lightbox Film", "灯箱画片", "デザインデータ、既存灯箱寸法、配送梱包を確認する画面資材。"],
...
const langConfig = {
  ja: {
    ...
    timelineSteps: ["工場確認", "サンプル / 仕様確認", "梱包", "国際物流", "日本国内配送", "現場引き渡し"],
    partnerTitle: "工務店連携",
  ...
  en: {
    ...
    timelineSteps: ["Factory confirmation", "Sample / specification", "Packing", "International logistics", "Japan delivery", "Site handover"],
  ...
  zh: {
    ...
    timelineSteps: ["工厂确认", "样品 / 规格确认", "包装", "国际物流", "日本国内配送", "现场交付"],
    partnerTitle: "工务店合作",
